...
Rails.application.routes.draw do
  ...
  Rails.application.routes.draw do
    ...
    root "root#index"
    post '/stripe_checkout', to: 'payments#stripe_checkout'
    get '/payments/success'
    get '/payments/cancel'
    get '/pay', to: 'payments#pay'

    # Session
    get '/check_site', to: 'sessions#check_site'
    ...
    get  'register_site',               to: 'sessions#register_site',             as: 'register_site'
    post 'signup',                      to: 'sessions#create_account',            as: 'signup'
    post 'create_site',                 to: 'sessions#create_site',               as: 'create_site'
    ...
    get  'update_tier',       to: 'cart#update_tier',           as: 'update_tier'
    post 'set_updated_tier',  to: 'cart#set_updated_tier',      as: 'set_updated_tier'
    ...
    post 'default_image',                                    to: 'account#default_image',             as: 'default_image'
