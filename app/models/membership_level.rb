...
class MembershipLevel < ApplicationRecord
    has_one :commission, class_name: 'MembershipLevelCommission'
  
    validates :level, presence: true, length: { maximum: 40 }, uniqueness: true
    validates :price, numericality: { greater_than_or_equal_to: 0 }
    validates :active, inclusion: { in: ['Active', 'Inactive'], message: "%{value} is not a valid status" }
    validates :usage_level, numericality: { only_integer: true, allow_nil: true }
    validates :discount_percent, numericality: { only_integer: true, allow_nil: true }

    # attribute :sequence, Integer, default: 1
    # attribute :active, String, limit: 10, default: "Active"
    # attribute :free_storage, String, limit: 3, default: "No"
    # attribute :display, String, limit: 3, default: "Yes"
end
