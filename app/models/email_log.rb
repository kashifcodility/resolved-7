class EmailLog < ApplicationRecord
    # Validations
    validates :type, length: { maximum: 40 }, allow_nil: true
    validates :email_from, length: { maximum: 50 }, allow_nil: true
    validates :email_to, length: { maximum: 200 }, allow_nil: true
    validates :subject, length: { maximum: 200 }, allow_nil: true
    validates :rich_text, allow_nil: true
